...
const getList = async(req, res) => {
    ...
    CategoryGroup.findAndCountAll(options)
        .then((result) => {
    ...
    CategoryGroup.create({
        ...
        .catch((err) => {
            res.status(statusErrors.badRequest).json({
                success: false,
                error: err.message,
                message: 'Xảy ra lỗi khi tạo mới nhóm chuyên mục!'
            });
        });
};
    ...
    CategoryGroup.update({
        ...
        .catch((err) => {
            res.status(statusErrors.badRequest).json({
                success: false,
                error: err.message,
                message: 'Xảy ra lỗi khi cập nhật nhóm chuyên mục!'
            });
        });
};
...
const updateStatus = async(req, res) => {
    ...
    CategoryGroup.update({ status: status }, {
            where: {
                id: id
            }
        })
